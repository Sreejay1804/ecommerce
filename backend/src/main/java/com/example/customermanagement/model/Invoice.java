...
public class Invoice {
    ...
    public void addItem(InvoiceItem item) {
        ...
        calculateTotalAmount(); // Auto-calculate when adding items
    }
    
    public void removeItem(InvoiceItem item) {
        items.remove(item);
        item.setInvoice(null);
        calculateTotalAmount(); // Auto-calculate when removing items
    }
    ...
    public void clearItems() {
        ...
        items.clear();
        this.totalAmount = BigDecimal.ZERO; // Reset total when clearing all items
    }
    
    /**
     * Calculates and sets the total amount from all invoice items
     */
    ...
    /**
     * Validates the invoice before persistence
     * @throws IllegalArgumentException if validation fails
     */
    public void validateForPersistence() {
        // Calculate total if not already set properly
    ...
    public void setItems(List<InvoiceItem> items) {
        ...
        calculateTotalAmount(); // Auto-calculate when setting items
    }
